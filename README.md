...
```mermaid
flowchart LR
    Step1["<b>1단계: 스펙 정의</b><br/>프로젝트 요건에 맞게<br/>frontend/DESIGN.md 작성"] --> Step2["<b>2단계: AI 에이전트 지시</b><br/>Cursor / Claude Code에<br/>DESIGN.md 기준 지시"] --> Step3["<b>3단계: 일관된 UI 생성</b><br/>스펙을 100% 준수한<br/>맞춤형 프론트엔드 구현"]
```
